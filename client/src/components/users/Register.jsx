  ...
  return (
    <Container className="my-5">
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <Form.Group>
          <label htmlFor="about">A short sentence including 3 things you love:</label>
          <Form.Control type="about" name="about" onChange={handleInputChange} value={inputs.about}/>
        </Form.Group>
